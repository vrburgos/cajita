...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Tue Oct 27 09:40:23 2015
#
...
class verificarImgs(wx.Frame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: verificarImgs.__init__
        kwds["style"] = wx.DEFAULT_FRAME_STYLE
        wx.Frame.__init__(self, *args, **kwds)
        self.panel_7 = wx.Panel(self, wx.ID_ANY)
        self.panel_11 = wx.Panel(self, wx.ID_ANY)
        self.button_6 = wx.Button(self, wx.ID_ANY, _("Escanear"))
        self.button_7 = wx.Button(self, wx.ID_ANY, _("Enviar"))
        self.panel_12 = wx.Panel(self, wx.ID_ANY)
        self.panel_10 = wx.Panel(self, wx.ID_ANY)
        self.bitmap_5 = wx.StaticBitmap(self, wx.ID_ANY, wx.NullBitmap)
        self.panel_15 = wx.Panel(self, wx.ID_ANY)
        self.panel_13 = wx.Panel(self, wx.ID_ANY)
        self.bitmap_6 = wx.StaticBitmap(self, wx.ID_ANY, wx.NullBitmap)
    ...
    def __set_properties(self):
        # begin wxGlade: verificarImgs.__set_properties
        self.SetTitle(_("frame_4"))
        self.SetSize((450, 704))
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: verificarImgs.__do_layout
        ...
        grid_sizer_6.Add(self.panel_11, 1, wx.EXPAND, 0)
        grid_sizer_6.Add(self.button_6, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_6.Add(self.button_7, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_6.Add(self.panel_12, 1, wx.EXPAND, 0)
        sizer_8.Add(grid_sizer_6, 1, wx.EXPAND, 0)
        grid_sizer_7.Add(self.panel_10, 1, wx.EXPAND, 0)
        grid_sizer_7.Add(self.bitmap_5, 0, 0, 0)
        grid_sizer_7.Add(self.panel_15, 1, wx.EXPAND, 0)
        sizer_8.Add(grid_sizer_7, 1, wx.EXPAND, 0)
        grid_sizer_8.Add(self.panel_13, 1, wx.EXPAND, 0)
        grid_sizer_8.Add(self.bitmap_6, 0, 0, 0)
...
class MyFrame2(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_4 = wx.StaticText(self, wx.ID_ANY, _(u"Contrase\xf1a:"))
    ...
    def __set_properties(self):
        ...
        self.SetSize((480, 704))
        self.label_3.SetFont(wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.text_ctrl_2.SetMinSize((120, 35))
        self.label_4.SetFont(wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.text_ctrl_3.SetMinSize((120, 35))
        self.button_1.SetMinSize((110, 35))
        self.button_1.SetFont(wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        # end wxGlade
...
class MyFrame4(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_7 = wx.StaticText(self, wx.ID_ANY, _("Poligono:"))
        self.label_8 = wx.StaticText(self, wx.ID_ANY, _("# Casa:"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("frame_5"))
        self.SetSize((480, 704))
        self.label_7.SetMinSize((80, 35))
        self.label_7.SetFont(wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.label_8.SetMinSize((70, 35))
        self.label_8.SetFont(wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.text_ctrl_6.SetMinSize((120, 35))
        self.text_ctrl_7.SetMinSize((120, 35))
        self.button_2.SetMinSize((100, 35))
        self.button_2.SetFont(wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
    ...
    def __do_layout(self):
        ...
        sizer_5.Add(self.label_7, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_5.Add(self.label_8, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        grid_sizer_3.Add(sizer_5, 1, wx.EXPAND, 0)
        sizer_6.Add(self.text_ctrl_6, 0, 0, 4)
        sizer_6.Add(self.text_ctrl_7, 0, 0, 0)
        grid_sizer_3.Add(sizer_6, 1, wx.EXPAND, 0)
        grid_sizer_3.Add(self.button_2, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
...
class MyFrame7(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.button_3 = wx.Button(self, wx.ID_ANY, _("Escanear"))
        self.panel_21 = wx.Panel(self, wx.ID_ANY)
        self.panel_17 = wx.Panel(self, wx.ID_ANY)
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Familia:"))
        self.label_9 = wx.StaticText(self, wx.ID_ANY, _("Hernandez"))
        self.panel_20 = wx.Panel(self, wx.ID_ANY)
        self.panel_19 = wx.Panel(self, wx.ID_ANY)
        self.label_2 = wx.StaticText(self, wx.ID_ANY, _("Poligono:"))
        self.label_10 = wx.StaticText(self, wx.ID_ANY, _("10"))
        self.panel_29 = wx.Panel(self, wx.ID_ANY)
        self.panel_22 = wx.Panel(self, wx.ID_ANY)
        self.label_5 = wx.StaticText(self, wx.ID_ANY, _("# Casa:"))
        self.label_11 = wx.StaticText(self, wx.ID_ANY, _("25"))
        self.panel_28 = wx.Panel(self, wx.ID_ANY)
        self.panel_23 = wx.Panel(self, wx.ID_ANY)
        self.label_6 = wx.StaticText(self, wx.ID_ANY, _("Estado:"))
        self.label_12 = wx.StaticText(self, wx.ID_ANY, _("Habitada"))
        self.panel_30 = wx.Panel(self, wx.ID_ANY)
    ...
    def __set_properties(self):
        ...
        self.label_10.SetFont(wx.Font(12, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
    ...
    def __do_layout(self):
        ...
        grid_sizer_2 = wx.GridSizer(6, 4, 0, 0)
        grid_sizer_2.Add(self.panel_16, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_18, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.button_3, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.panel_21, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_17, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.label_1, 0, 0, 0)
        grid_sizer_2.Add(self.label_9, 0, 0, 0)
        grid_sizer_2.Add(self.panel_20, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_19, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.label_2, 0, 0, 0)
        grid_sizer_2.Add(self.label_10, 0, 0, 0)
        grid_sizer_2.Add(self.panel_29, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_22, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.label_5, 0, 0, 0)
        grid_sizer_2.Add(self.label_11, 0, 0, 0)
        grid_sizer_2.Add(self.panel_28, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_23, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.label_6, 0, 0, 0)
        grid_sizer_2.Add(self.label_12, 0, 0, 0)
        grid_sizer_2.Add(self.panel_30, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_25, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_24, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_26, 1, wx.EXPAND, 0)
        grid_sizer_2.Add(self.panel_27, 1, wx.EXPAND, 0)
